...
.defines( function() {
    ...
    Inventory = ig.Class.extend({
        ...
        addItem: function(itemID, index) {
//            if (this.contains(itemID)) {
//                this.getItemByID(itemID).quantity++;
//                this._indexToNum[itemID]++;
//            }
//            else {
//                var newIndex = this.getFirstEmptySlot();
//                if (newIndex >= 0) {
//                    this._items[newIndex] = this._itemFactory.generateItem(itemID);
//                }
//                else {
...
//            }
            ...
            if(!index) {
                for(var i = 0;i < this._items.length;i++) {
                    ...
                    if(currItem && currItem.itemID == itemID && currItem.quantity < currItem.maxQuantity) {
                        index = i;
                        break;
                    }
                }
...
//                return;
            ...
            if (currItem && currItem.itemID == itemID && currItem.quantity < currItem.maxQuantity){
                ...
                this._items[index] = this._itemFactory.generateItem(itemID);
