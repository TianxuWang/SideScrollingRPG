...
.defines( function(){
    ...
    Assets = ig.Class.extend({
        ...
        animSheet_merchant_female: new ig.AnimationSheet('media/npcs/merchant_female.png', 18, 26),
        ...
        animSheet_coin: new ig.AnimationSheet('media/items/coin.png', 4, 4),
        ...
        img_dialogue_nextArrow: new ig.Image('media/gui/dialogue_nextarrow.png'),
        ...
        img_gold_icon: new ig.Image('media/items/gold_icon.png'),

        // sfx

        // music
        bgMusic_town: new ig.Sound('media/musics/Track_3.*', false),
        bgMusic_forest: new ig.Sound('media/musics/Track_10.*', false),
