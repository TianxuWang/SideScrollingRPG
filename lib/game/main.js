...
.defines(function(){
	...
	var MyGame = ig.Game.extend({
        ...
        playerLvlTag: new ig.Font('media/04b03.font.png'),
		...
		init: function() {
            ...
            // gui
            this.playerHud = new ig.Image('media/gui/hud_player.png');
            this.playerHealthBar = new Bar(new ig.Image('media/gui/healthbar2.png'));
            this.playerManaBar = new Bar(new ig.Image('media/gui/manabar2.png'));
            this.enemyHealthBar = new Bar(new ig.Image('media/gui/ragebar.png'), new ig.Image('media/gui/emptybar.png'));
		...
		draw: function() {
            ...
            if (this.playerManaBar) {
                this.playerManaBar.maxValue = player.maxMana;
                this.playerManaBar.value = player.mana;
            ...
            if (this.playerLvlTag)
                this.playerLvlTag.draw('Lv.' + player.level, this.playerHealthBar.pos.x + 48, this.playerHealthBar.pos.y - 8, ig.Font.ALIGN.LEFT);
