...
.defines(function(){
	...
	var MyGame = ig.Game.extend({
        ...
        initPlayer: function() {
            this.spawnEntity('EntityNinja', 33, 123);
        },
        ...
        fadeIn: function(_speed, _callback) {
            this.screenFader = new ig.ScreenFader({ fade: 'out', speed: _speed?_speed:2, callback: _callback });
        },

        fadeOut: function(_speed, _callback) {
            this.screenFader = new ig.ScreenFader({ fade: 'in', speed: _speed?_speed:2, callback: _callback });
        }
	});
