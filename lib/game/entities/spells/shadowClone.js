...
.defines ( function() {
    ...
    EntityShadowClone = EntityCharacter.extend ({
        ...
        init: function(x, y, settings) {
            ...
            this.health = this.maxHealth = this.owner.maxHealth/2;
            this._attack = this.owner._attack;
            this.defence = this.owner.defence;
            this._attackSpeed = this.owner._attackSpeed;
            this._critHitChance = this.owner.critHitChance;
            this._critHitDamage = this.owner.critHitDamage;
