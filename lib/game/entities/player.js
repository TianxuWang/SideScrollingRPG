...
.defines ( function() {
    ...
    EntityPlayer = EntityCharacter.extend ({
        ...
        initBars: function() {
            this.healthBar = new Bar(this, 'health', ig.game.assets.img_player_healthBar);
            this.healthBar.pos = {x: 44, y: 18};
            this.manaBar = new Bar(this, 'mana', ig.game.assets.img_player_manaBar);
        ...
        addStates: function() {
            ...
            this.stateMachine.state(this.State.ATTACKGROUND, {
                ...
                update: function() {
                    ...
                    if (self.currentAnim == self.anims.attackGround && self.currentAnim.frame > 3 && ig.input.pressed('attack'))
