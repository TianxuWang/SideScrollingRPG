...
.defines ( function() {
    ...
    EntityPlayer = EntityCharacter.extend ({
        ...
        initBars: function() {
            this.healthBar = new Bar(this, 'health', new ig.Image('media/gui/healthbar2.png'));
            this.healthBar.pos = {x: 44, y: 18};
            this.manaBar = new Bar(this, 'mana', new ig.Image('media/gui/manabar2.png'));
            this.manaBar.pos = {x: 44, y: 26};
        },

        initEquipments: function() {
            this.equipments.mainHand = ig.game.itemFactory.generateItem(0);
        },

        initInventory: function() {
            this.inventory = new Inventory(this);
            this.inventory.gold = 500;
            this.inventory.addItem(ig.game.itemFactory.generateItem(1));
            this.inventory.addItem(ig.game.itemFactory.generateItem(2));
        },
        ...
        initWeapon: function() {
            ...
            this.activeWeapon.offsetIdlePos();
            this.activeWeapon.updateFlip();
        ...
        updateEquipment: function() {
            ...
            this.initAttributes();
            // TODO: update attack animation based on attackSpeed. Need to make this more generic
            this.anims.attackGround.frameTime = this.attackSpeed;
            this.anims.attackGround2.frameTime = this.attackSpeed;
            this.anims.attackGround3.frameTime = this.attackSpeed;
        ...
        updateHealth: function() {
            ...
            if (this._disengageTimer.delta() >= this._disengageDelay && this.health < this.healthMax) {
        ...
        addStates: function() {
            ...
            this.stateMachine.state(this.State.RUNNING, {
                ...
                exit: function() {
                    if (self.standing && Math.abs(self.vel.x) == self.maxVel.x)
                        self._emitSmokeParticle('end');
        ...
        addTransitions: function() {
            ...
            this.stateMachine.transition('AttackGroundToIdle', 'attackGround', 'idle', function(){
                return self.currentAnim.loopCount && !ig.input.state('left') && !ig.input.state('right') && !self._inAttackCombo;
            });
        ...
        sell: function(item) {
            ...
            this.inventory.gold += item.price;
            ig.game.menuTrade._inventory.addItem(item);
        },
        ...
        _emitSmokeParticle: function(_type) {
            this.smokeParticle = ig.game.spawnEntity('EntitySmokeParticle', this.pos.x, this.pos.y, {owner: this, type: _type});
        }
    });
