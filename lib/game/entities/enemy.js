...
.defines ( function() {
    ...
    EntityEnemy = EntityCharacter.extend ({
        ...
        updateSeenPlayer: function() {
            ...
            this.seenPlayer = ((!this.flip && this.isOnLeftOf(player)) || (this.flip && !this.isOnLeftOf(player))) && this.isNear(player, 60, 60);
        },
        ...
        hurt: function(fromLeft, damageObj) {
            ...
            //var _weaponCenterX = attacker.activeWeapon.pos.x + attacker.activeWeapon.size.x/2;
            //var _weaponCenterY = attacker.activeWeapon.pos.y + attacker.activeWeapon.size.y/2;
            //this.bloodEmitter.setPos((_weaponCenterX+this.center.x)/2+(attacker.flip?-24:8), (_weaponCenterY+this.center.y)/2-8);
