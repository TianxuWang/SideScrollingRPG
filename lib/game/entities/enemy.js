...
.defines ( function() {
    ...
    EntityEnemy = EntityCharacter.extend ({
            ...
            this.healthBar = ig.game.spawnEntity('EntityBar', 0, 0,
                {
                    owner: this,
                    target: 'health',
                    barImage: ig.game.assets.img_enemy_healthBar,
                    trackImage: ig.game.assets.img_enemy_trackBar
                }
            );
        },
        ...
        initDroppableManager: function() {
            this.droppableManager = new DroppableManager(this);
        },
