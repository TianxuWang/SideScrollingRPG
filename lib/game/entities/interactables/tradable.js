...
.defines( function() {
    ...
    EntityTradable = EntityInteractable.extend({
        ...
        initInventory: function() {
            ...
            // For now, need to comment out this line for the 'Town' map to be loaded in Weltmeister
        ...
        buy: function(item) {
            ...
            ig.game.player.inventory.gold += item.price;
            ig.game.cursorItem = null;
        },

        sell: function(item) {
            var playerInv = ig.game.player.inventory;
