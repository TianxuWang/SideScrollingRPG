...
wm.config = {
	...
	project: {
		...
		'entityFiles': [
            ...
            'lib/game/entities/classes/*.js',
            'lib/game/entities/enemies/*.js',
            'lib/game/entities/interactables/*.js',
            'lib/game/entities/interactables/npcs/*.js',
            'lib/game/entities/utils/*.js'
        ],
